document.addEventListener("DOMContentLoaded", loadCategoryInsightData());

async function loadCategoryInsightData() {
  try {
    ...
    const response = await fetch(API_URL + "/issues/category-count", {
      headers: headers,
    });
